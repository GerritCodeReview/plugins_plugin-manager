...
@Singleton
public class XAuthInjectFilter implements Filter {
  private static final Logger log = LoggerFactory.getLogger(XAuthInjectFilter.class);

  private DynamicItem<WebSession> webSession;

  @Inject
  public XAuthInjectFilter(DynamicItem<WebSession> webSession) {
