...
junit_tests(
    ...
    srcs = glob(
        ...
        exclude = ["src/test/java/com/googlesource/gerrit/plugins/manager/repository/PluginsRepositoryTest.java"],
    ),
...
junit_tests(
    ...
    srcs = glob(["src/test/java/com/googlesource/gerrit/plugins/manager/repository/PluginsRepositoryTest.java"]),
    tags = [
        "manual",
    ],
    visibility = ["//visibility:public"],
